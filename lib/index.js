...
/* JSSTYLED */
var attrRegex = /^[a-zA-Z][-a-zA-Z0-9]*/;
...
function parseExt(attr, str)
{
  ...
  /*
   * Coming from the original ldapjs code, handling for a few ExtensibleFilter
   * rules was built into the implementation.  This logic is preserved here.
   */
  if (res.rule === '2.5.13.4' || res.rule === 'caseIgnoreSubstringsMatch') {
...
module.exports = {
  parse: function (str) {
    ...
    return parseFilter(str, 0).filter;
  },
